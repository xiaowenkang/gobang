...
public class ChessBoard extends JPanel implements MouseListener {
	...
	public ChessBoard() {
		...
		// URL(ClassLoader.getSystemResource(""), "board.jpg"));
		img = Toolkit.getDefaultToolkit().getImage((getClass().getClassLoader().getResource("board1.jpg")));
	...
	public void paintComponent(Graphics g) {
		...
		for (int i = 0; i < chessCount; i++) {
			...
			if (colortemp == Color.black) {
				...
				RadialGradientPaint paint = new RadialGradientPaint(xPos - Point.DIAMETER / 2 + 25,
						yPos - Point.DIAMETER / 2 + 10, 80, new float[] { 0f, 1f },
						new Color[] { Color.WHITE, Color.BLACK });
				((Graphics2D) g).setPaint(paint);
				((Graphics2D) g).setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
				((Graphics2D) g).setRenderingHint(RenderingHints.KEY_ALPHA_INTERPOLATION,
